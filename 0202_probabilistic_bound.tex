...
We define
\begin{equation*}
    \bar\eta_n = \argmax_{h\in \mathbb G} \p\Lambda(h),
\end{equation*}
...
\begin{definition}[Big-O and small-o in probability]
    ...
    \begin{equation*}
        X_n = o_P(a_n)
    \end{equation*}
    if $X_n/a_n \rightarrow 0$ in probability, that is, for every $\varepsilon > 0$ and every $\delta > 0$, there exists $N < \infty$ such that
    \begin{equation*}
...
\begin{enumerate}[label=\arabic*., leftmargin=2.5em]
    ...
    \begin{equation*}
        -M_1 \|h\|_\E^2 \leq \Lambda(\eta_0 + h) - \Lambda(\eta_0) \leq -M_2 \|h\|_\E^2
    \end{equation*}
    for all $h \in\mathbb G$ with $\|h\|_\infty \leq B$;
    \item $\lim_n \delta_n\vee\lambda_n = 0$;
    \item $\displaystyle \lim_n A_n^2 \{\delta_n^{2p'} \vee (\lambda_n \delta_n^{2(p'-q)\wedge 0})\} = 0$.
\end{enumerate}
Then
\begin{enumerate}[label=\alph*., leftmargin=2.5em]
    \item Then $\bar\eta_n$ exists and is bounded;
    \item $\|\bar\eta_n - \eta_0\|_\infty = o(1)$;
    \item $\|\bar\eta_n - \eta_0\|^2 + \lambda_n J_q(\bar\eta_n) = O\{\delta_n^{2p'} \vee \lambda_n \delta_n^{2(p'-q)\wedge 0}\}$, with $p' = p \wedge (m+1)$.
\end{enumerate}
\end{theorem}
...
\end{equation*}
    ...
    \item $\lim_n \delta_n\vee\lambda_n = 0$;
    \item $\displaystyle \lim_n A_n^2 \left(\frac{1}{n \lambda_n^{1/(2q)}} \wedge \frac{1}{n \delta_n}\right)=0$.
\end{enumerate}
Then
\begin{enumerate}[label=\alph*., leftmargin=2.5em]
