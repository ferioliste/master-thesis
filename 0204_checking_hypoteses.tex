...
Since these are conditions on the sequence of spline spaces $(\mathbb G_n)_{n\in\N}$ and the sequence of penalty parameters $(\lambda_n)_{n\in\N}$, they can be verified once and for all. In particular, after fixing the sequences the same conditions apply regardless of the utility function used to define the estimator. For this reason, in \autoref{ch:chapter2}, we will not check these conditions.
