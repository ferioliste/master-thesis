...
Since
\begin{equation*}
    0 \leq A_n^2 \{\delta_n^{2p'} \vee (\lambda_n \delta_n^{2(p'-q)\wedge 0})\} \leq C^2\delta_n^{-1}\{\delta_n^{2p'} \vee (\lambda_n \delta_n^{2(p'-q)\wedge 0})\}
\end{equation*}
and
\begin{equation*}
...
\begin{equation*}
    \lim_{n\rightarrow\infty} \delta_n^{-1}\{\delta_n^{2p'} \vee (\lambda_n \delta_n^{2(p'-q)\wedge 0})\} = 0
\end{equation*}
and
\begin{equation*}
...
\begin{enumerate}
    ...
    \end{equation*}
    holds for $g \in\mathbb G$ with $\|g\|_\infty \leq B$, with probability tending to one as $n \rightarrow \infty$.
\end{enumerate}
