...
The first point we have to deal with is which basis to use in order to represent the splines in $\mathbb G$ in a way that is convenient for numerical computations. We define the truncated power basis functions $(\varphi_i)_{i\in{0,\ldots,m+k}}$ by
\begin{equation*}
...
In our implementation, we determine the coefficient vector of $\hat\eta_n$.