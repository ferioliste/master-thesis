...
It follows that the first $q$ rows and columns of $G_q$ are filled $0$. In addition, every entry of $G_q$ can be calculated exactly by integrating polynomials. For example, take $i\in\{q,\ldots,m\}$ and $j\in\{1,\ldots,k\}$, then
\begin{gather*}
