...
In addition, in all experiments we use uniformly spaced knots on $[a,b]$. For a given number of interior knots $k$, we take 
\begin{equation*}
    t_i = a+i\,\frac{b-a}{k+1}\qquad\text{for }i=0,\ldots,k+1.
\end{equation*}
