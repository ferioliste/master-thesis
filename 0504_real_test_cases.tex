...
One noticeable difference between the Simple Maximum Likelihood estimate and the Generalized Score Matching estimate is that, in the first, the density increases again as $22{:}00$ approaches. As in the synthetic experiments, the Generalized Score Matching estimate shows a poorer behavior close to the boundary of the support. However, both spline-based methods appear to perform better than the KDE, especially near the boundaries. They also have the practical advantage of being much faster to evaluate, since the cost of evaluating the KDE at a point grows linearly with $n$.
